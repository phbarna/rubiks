...
public class Cube {
  ...
  public CubeStatus buildCubeFromString(String sixLines) {
    ...
    Side[] sides =
        {orangeSide, blueSide, redSide, greenSide}; // first just iterate the 4 x-axis sides
  ...
  public int followAlgorithm(String algorithm, boolean stopOnSolved) {
    ...
    int instructionNumber =
        1; // keeps track of number of instructions so that we know how long a solve takes
    for (String instruction : instructions) {
